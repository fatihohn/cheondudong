    ...
    function markerSize() {
        ...
        if (zoomStatus > zoomLow && zoomStatus < zoomHigh) {
            ...
            for(mnc=0; mnc < miniCubeAll.length; mnc++) {
                ...
                miniCubeAll[mnc].style.transition = "0.05s";
            ...
            for(sc=0; sc < smallCubeAll.length; sc++) {
                ...
                smallCubeAll[sc].style.transition = "0.05s";
            ...
            for(mc=0; mc < middleCubeAll.length; mc++) {
                ...
                middleCubeAll[mc].style.transition = "0.05s";
            ...
            for(sh=0; sh < smallHoriAll.length; sh++) {
                ...
                smallHoriAll[sh].style.transition = "0.05s";
            ...
            for(mh=0; mh < middleHoriAll.length; mh++) {
                ...
                middleHoriAll[mh].style.transition = "0.05s";
            ...
            for(bh=0; bh < bigHoriAll.length; bh++) {
                ...
                bigHoriAll[bh].style.transition = "0.05s";
            ...
            for(sp=0; sp < smallPanoAll.length; sp++) {
                ...
                smallPanoAll[sp].style.transition = "0.05s";
            ...
            for(mp=0; mp < middlePanoAll.length; mp++) {
                ...
                middlePanoAll[mp].style.transition = "0.05s";
            ...
            for(lp=0; lp < longPanoAll.length; lp++) {
                ...
                longPanoAll[lp].style.transition = "0.05s";
            ...
            for(lv=0; lv < longVertiAll.length; lv++) {
                ...
                longVertiAll[lv].style.transition = "0.05s";

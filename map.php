...
trackUserLocation: true
    ...
    function markerSize() {
        ...
        for(sc=0; sc < smallCubeAll.length; sc++) {
            ...
            smallCubeAll[sc].style.height = "calc(60px + 25px)";
        ...
        for(mc=0; mc < middleCubeAll.length; mc++) {
            ...
            middleCubeAll[mc].style.height = "calc(80px + 25px)";
        ...
        for(sh=0; sh < smallHoriAll.length; sh++) {
            ...
            smallHoriAll[sh].style.height = "calc(50px + 25px)";
        ...
        for(mh=0; mh < middleHoriAll.length; mh++) {
            ...
            middleHoriAll[mh].style.height = "calc(60px + 25px)";
        ...
        for(bh=0; bh < bigHoriAll.length; bh++) {
            ...
            bigHoriAll[bh].style.height = "calc(100px + 25px)";
        ...
        for(sp=0; sp < smallPanoAll.length; sp++) {
            ...
            smallPanoAll[sp].style.height = "calc(40px + 25px)";
        ...
        for(mp=0; mp < middlePanoAll.length; mp++) {
            ...
            middlePanoAll[mp].style.height = "calc(60px + 25px)";
        ...
        for(lp=0; lp < longPanoAll.length; lp++) {
            ...
            longPanoAll[lp].style.height = "calc(60px + 25px)";
